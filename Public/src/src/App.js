...
const generateWordCloudData = (entries) => {
  const wordMap = {};
  // Combine "Past" (Gratitude) and "Future" (Hope) for a full picture, or just "Past"
...
export default function App() {
  ...
  const DashboardView = () => {
    const cloudData = generateWordCloudData(entries);
          ...
          <div className="space-y-12">
            ...
            <div>
              ...
              <div className="flex flex-wrap justify-center items-center gap-4 p-8 border border-gray-800 rounded-lg bg-gray-900/20 min-h-[200px]">
                {cloudData.length > 0 ? cloudData.map((wordObj, index) => {
                  ...
                  return (
                    ...
                    }} className="font-serif text-white hover:text-blue-200 cursor-default">
                      {wordObj.text}
                    </span>
                  )
  ...
  return (
    <div className="min-h-screen bg-black text-white font-sans selection:bg-gray-800">
      <div className="max-w-3xl mx-auto px-6 py-8">
        ...
        {/* Main Content Area */}
        {view === 'entry' ? <EntryView /> : <DashboardView />}
